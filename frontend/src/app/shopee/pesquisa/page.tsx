...
export default function ShopeeSearchPage() {
    ...
    const handleSearch = async () => {
        ...
        try {
            ...
            // const res = await fetch(`http://localhost:3000/marketplace/search?platform=SHOPEE&q=${searchTerm}`);

            // For now, let's simulate the backend response with a delay
            await new Promise(r => setTimeout(r, 1500));

            // Mocking results to show the UI functionality
            setResults([
                {
                    id: "1",
                    name: "Fone de Ouvido Bluetooth TWS",
                    price: "49,90",
                    image: "https://cf.shopee.com.br/file/example1",
                    url: "https://shopee.com.br/product1"
                },
                {
                    id: "2",
                    name: "Smartwatch Ultra Series 8",
                    price: "129,00",
                    image: "https://cf.shopee.com.br/file/example2",
                    url: "https://shopee.com.br/product2"
                }
            ]);
        } catch (error) {
